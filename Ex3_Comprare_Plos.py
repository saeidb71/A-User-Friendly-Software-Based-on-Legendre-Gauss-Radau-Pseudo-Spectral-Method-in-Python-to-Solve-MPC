...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun 30 14:11:01 2022
...
Result_data_Test1=Read_Result(os.getcwd()+'/Results/'+'Ex3_Test1')
Result_data_Test2=Read_Result(os.getcwd()+'/Results/'+'Ex3_Test2')
Exact=os.getcwd()+'/Results/'+'Ex3_Exact'
...
ax_1.plot(time_h_2,state_sol_ode[:,0],'--',linewidth=2, label='$\mathrm{Exact}$')
...
ax_3.plot(time_h_2,u_opt_analytic,'--',linewidth=2, label='$\mathrm{Exact}$')
